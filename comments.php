...
<div id="comments" class="comments-area">
    ...
    if ( have_comments() ) : ?>
        ...
        <h2 class="comments-title">
            ...
            if ( '1' === $comments_number ) {
                ...
                printf( _x( 'One comment on &ldquo;%s&rdquo;', 'comments title', 'wp-bootstrap-starter' ), get_the_title() );
            } else {
                printf(
  ...
  'url' =>
    '<p class="comment-form-url"><label for="url">' . __( 'Web site', 'domainreference' ) . '</label>' .
	...
	<script>
		jQuery('#commentsubmit').on('click', function() {
			alert('Thank you for your comment. It will display once it has been approved.');
